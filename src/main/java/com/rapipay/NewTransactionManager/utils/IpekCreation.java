...
import com.rapipay.NewTransactionManager.security.DES;
import com.rapipay.NewTransactionManager.security.TripleDES;

public class IpekCreation {


	private IpekCreation() {
