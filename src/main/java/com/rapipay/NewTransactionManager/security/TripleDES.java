...
public final class TripleDES
{
    ...
    public static byte[] encrypt(byte[] data, byte[] key)
    {
        ...
        try
        {
            ...
            return enc;
        } catch (javax.crypto.NoSuchPaddingException | java.security.NoSuchAlgorithmException
    ...
    public static byte[] decrypt(byte[] data, byte[] key)
    {
        ...
        try
        {
            ...
            return enc;
                ...
                | javax.crypto.BadPaddingException | IllegalBlockSizeException e)
        {
        }
    ...
    public static byte[] encrypt_CBC(byte[] data, byte[] key, byte[] IV)
    {
        ...
        try
        {
            ...
            return enc;
        } catch (javax.crypto.NoSuchPaddingException | java.security.NoSuchAlgorithmException | java.security.InvalidKeyException | javax.crypto.BadPaddingException | IllegalBlockSizeException e)
        {
