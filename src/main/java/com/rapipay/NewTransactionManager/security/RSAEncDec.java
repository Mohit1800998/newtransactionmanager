...
public class RSAEncDec {
    ...
    public static byte[] encrypt1(String data, String publicKey) throws BadPaddingException, IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, UnsupportedEncodingException {
    ...
    public static String decrypt(String data, String base64PrivateKey)  {
    	try {
    	 ...
    	 public static String decrypt1(String data, String base64PrivateKey)  {
    	    	try {
    	    		return decrypt1(Base64.getDecoder().decode(data.getBytes()), getPrivateKey(base64PrivateKey));
    	    	}
    	    	catch(Exception e) {
    	    		e.printStackTrace();
    	    		return "error";
    ...
    public static String encryptByRsa(String plainData) {
		try {
